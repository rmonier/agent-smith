---
type: "source-file"
title: ".agents/skills/agent-ready-context/scripts/editorial_pass.py"
description: "Repository source file staged for OpenKB ingestion."
resource: ".agents/skills/agent-ready-context/scripts/editorial_pass.py"
source_path: ".agents/skills/agent-ready-context/scripts/editorial_pass.py"
source_kind: "code"
source_hash: "sha256:e8f753e619b4cd414e47a73d799b5b036690b13e88039b499171e3bf5136eb69"
...
def run_vendor_template(py: Path, targets: set[str]) -> tuple[str, str, bool]:
    ...
    """
    proc = run_utf8(
        [str(py), "-c", _VENDOR_RUNNER_PRIVATE_TEMPLATE, json.dumps(sorted(targets))]
    )
    if proc.returncode == 0:
        try:
