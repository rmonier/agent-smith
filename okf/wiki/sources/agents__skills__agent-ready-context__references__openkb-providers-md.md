---
type: "source-file"
title: ".agents/skills/agent-ready-context/references/openkb-providers.md"
description: "Repository source file staged for OpenKB ingestion."
resource: ".agents/skills/agent-ready-context/references/openkb-providers.md"
source_path: ".agents/skills/agent-ready-context/references/openkb-providers.md"
source_kind: "markdown"
source_hash: "sha256:135943a0259a74c5dfe67fb780373847399952af380caf3a9942a175cded1e73"
source_commit: "9b3f3ff908957a34a8e9fa6e5d402f659cd02cba"
tags: [source-file, markdown]
---

# .agents/skills/agent-ready-context/references/openkb-providers.md
...
`LLM_API_KEY` is a universal key routed by litellm to the detected provider. Provider-specific variables such as `ANTHROPIC_API_KEY` also work. Keep every `.env` file gitignored; interactive `openkb init` can write API keys into `okf/.env`.
