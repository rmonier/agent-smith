...
Context: `AGENTS.md`, `okf/wiki/index.md`, relevant OKF pages, `agent-ready-context` skill.
...
Context: `AGENTS.md`, `okf/wiki/index.md`, existing `.agents/skills/`, `skill-creator` skill.
...
Context: `AGENTS.md`, file tree, relevant source files.
